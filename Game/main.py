...
# Clouds
cloud_colors = [(200, 200, 200), (220, 220, 220), (240, 240, 240)]
for i in range(10):
    cloud_x = random.randint(0, display.get_width())
    cloud_y = random.randint(0, display.get_height() // 2)
    cloud_width = random.randint(20, 80)
    cloud_height = random.randint(10, 30)
    pygame.draw.ellipse(display, random.choice(cloud_colors), (cloud_x, cloud_y, cloud_width, cloud_height))# Background
    display.fill((255, 255, 255))  # White background
    ...
    for i in range(10):
        ...
        cloud_width = random.randint(20, 80)
        cloud_height = random.randint(10, 30)
        pygame.draw.ellipse(display, random.choice(cloud_colors), (cloud_x, cloud_y, cloud_width, cloud_height))
def load_map(map_id):
...
# Loop ------------------------------------------------------- #
    while True:
        ...
        # Background --------------------------------------------- #
        screen.fill((5, 18, 24))  # Keep the dark blue background color
        display.fill((255, 255, 255))  # Set the white background color
        ...
        for i in range(9):
            pygame.draw.line(display, (173, 216, 230), (-10, int(i * 30 + background_offset - 20)), (display.get_width() + 10, int(i * 30 - 110 + background_offset)), 15)  # Change the color to light blue
